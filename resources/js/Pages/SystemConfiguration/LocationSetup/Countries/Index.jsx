...
export default function Index({ auth, countries, filters }) {
    ...
    useEffect(() => {
        get(route("systemconfiguration1.countries.index"), { preserveState: true });
    ...
    const handleModalConfirm = async () => {
        try {
            await router.delete(route("systemconfiguration1.countries.destroy", modalState.countryToDeleteId));
        } catch (error) {
            ...
            <div className="container mx-auto p-4">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center mb-4">
                    <div className="flex items-center space-x-2 mb-4 md:mb-0">
                        ...
                        <Link
                            href={route("systemconfiguration1.countries.create")}
                                ...
                                countries.data.map((country, index) => (
                                    <tr key={country.id} className={index % 2 === 0 ? 'bg-gray-50' : ''}>
                                        ...
                                        <td className="border-b p-3 flex space-x-2">
                                            <Link
                                                href={route("systemconfiguration1.countries.edit", country.id)}
