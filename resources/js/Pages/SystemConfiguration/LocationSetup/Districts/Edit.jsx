...
export default function Edit({ district,regions }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        setIsSaving(true);
        put(route('systemconfiguration1.districts.update', district.id), {
            onSuccess: () => {
                setIsSaving(false);
                resetForm();
            },
                    ...
                    <div className="bg-white p-6 shadow sm:rounded-lg">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex justify-end space-x-4 mt-6">
                                <Link
                                    href={route('systemconfiguration1.districts.index')}  // Using the route for navigation
