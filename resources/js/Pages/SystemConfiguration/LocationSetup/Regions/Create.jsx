...
export default function Create() {
    ...
    const handleSubmit = (e) => {
        ...
        setIsSaving(true);
        post(route('systemconfiguration1.regions.store'), {
            onSuccess: () => {
                setIsSaving(false);
                resetForm();
            },
    ...
    const resetForm = () => {
        reset();
        showAlert('Region created successfully!');
    };

    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">New Region</h2>}
        >
                    ...
                    <div className="bg-white p-6 shadow sm:rounded-lg">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex justify-end space-x-4 mt-6">
                                ...
                                <Link
                                    href={route('systemconfiguration1.regions.index')}  // Using the route for navigation
