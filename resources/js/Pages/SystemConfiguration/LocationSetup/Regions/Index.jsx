...
export default function Index({ auth, regions, filters }) {
    ...
    useEffect(() => {
        get(route("systemconfiguration1.regions.index"), { preserveState: true });
    ...
    const handleModalConfirm = async () => {
        try {
            await router.delete(route("systemconfiguration1.regions.destroy", modalState.regionToDeleteId));
        } catch (error) {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold text-gray-800">Region List</h2>}
        >
            ...
            <div className="container mx-auto p-4">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center mb-4">
                    <div className="flex items-center space-x-2 mb-4 md:mb-0">
                        ...
                        <Link
                            href={route("systemconfiguration1.regions.create")}
                        ...
                        <Link
                            href={route("systemconfiguration1.index")}
                                ...
                                regions.data.map((region, index) => (
                                    <tr key={region.id} className={index % 2 === 0 ? 'bg-gray-50' : ''}>
                                        ...
                                        <td className="border-b p-3 flex space-x-2">
                                            <Link
                                                href={route("systemconfiguration1.regions.edit", region.id)}
