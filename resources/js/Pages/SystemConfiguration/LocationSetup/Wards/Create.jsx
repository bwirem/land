...
export default function Create({ regions, districts }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        setIsSaving(true);
        post(route('systemconfiguration1.wards.store'), data, {
                    ...
                    <div className="bg-white p-6 shadow sm:rounded-lg">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex justify-end space-x-4">
                                <Link href={route('systemconfiguration1.wards.index')} className="bg-gray-300 text-gray-700 rounded p-2 flex items-center space-x-2">
