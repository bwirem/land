...
export default function Index({ auth, facilityoptions, filters }) {
    ...
    useEffect(() => {
        get(route("systemconfiguration2.facilityoptions.index"), { preserveState: true });
    ...
    const handleModalConfirm = async () => {
        try {
            await router.delete(route("systemconfiguration2.facilityoptions.destroy", modalState.facilityoptionToDeleteId));
        } catch (error) {
            ...
            <div className="container mx-auto p-4">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center mb-4">
                    <div className="flex items-center space-x-2 mb-4 md:mb-0">
                        ...
                        <Link
                            href={route("systemconfiguration2.facilityoptions.create")}
                                ...
                                facilityoptions.data.map((facilityoption, index) => (
                                    <tr key={facilityoption.id} className={index % 2 === 0 ? 'bg-gray-50' : ''}>
                                        ...
                                        <td className="border-b p-3 flex space-x-2">
                                            <Link
                                                href={route("systemconfiguration2.facilityoptions.edit", facilityoption.id)}
